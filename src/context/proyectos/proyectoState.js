...
//es el state inicial de la administracion del proyecto
const ProyectoState = props => {
    ...
    const initialState = {
        ...
        //luego le agregamos la funcionalidad para volverlo a true
        formulario : false,
    ...
    // Selecciona el Proyecto que el usuariodio click
